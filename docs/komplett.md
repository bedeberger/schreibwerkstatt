...
- **Single-Pass-Cache nie bei Teilfehler einfrieren** (`relationsFailed`/`faktenFailed`/`eventsFailed` → Skip). Test: [komplett.test.js](../tests/integration/komplett.test.js).
