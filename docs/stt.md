...
- **Live-Status-Indikator** ([editor-notebook.html](../public/partials/editor-notebook.html), `.stt-status` in [page-view.css](../public/css/page/page-view.css)): Label neben dem Mic-Button mit Punkt-Indikator. `stt.status.listening` (bereit), `stt.status.hearing` (Sprache erkannt, roter Puls), `stt.status.transcribing` (Segment-Upload laeuft, Akzent-Puls). Reduced-Motion: kein Puls.
...
- **Button** ([editor-notebook.html](../public/partials/editor-notebook.html)): `x-if="sttEnabled"`, Markup wie der Entity-Toggle (`.graph-tool-btn`), Icon `#mic`. Recording-State (roter Puls) via CSS in [page-view.css](../public/css/page/page-view.css) (`.stt-mic-btn.is-recording[aria-pressed="true"]`).
