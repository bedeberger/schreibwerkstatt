...
- [docs/buchchat-tools.md](docs/buchchat-tools.md) — Agentic Buch-Chat: Tool-Inventar (32 Stück inkl. `final_answer`-Endpunkt), `ctx`-Vertrag, Truncation, Loop-Constraints, neues Tool anlegen.
