...
- [docs/plot.md](docs/plot.md) — Plot-Werkstatt (Beat-Board): Akte/Beats als Kanban-Spalten/-Karten (`plot_acts`/`plot_beats`/`plot_beat_figures`), CRUD + DnD-Reordering, zwei planende KI-Jobs (Brainstorm pro Akt + Consistency gegen Buchrealität), pro Buch + User skopiert, nie generativ in den Text.
