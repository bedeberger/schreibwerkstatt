...
// Der Mapper ist die SSoT fuer das Domain-Shape; localdb-Backend befuellt
// dieselben Shapes aus lokalen Tabellen.
...
function mapChapter(bs) {
  ...
  return {
    ...
    parent_chapter_id: bs.parent_chapter_id ?? null,
    updated_at: bs.updated_at || null,
    created_at: bs.created_at || null,
  };
}
