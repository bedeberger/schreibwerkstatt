'use strict';
// Phase 1 (BookStack-Exit, docs/bookstack-exit.md): BookStack-Variante der
// Content-Store-Facade. Vertrag identisch zu backends/localdb.js. Tripwire:
// `bsGet`/`bsPut`/`bsGetAll`/`bsBatch` duerfen nur hier + in lib/bookstack.js +
// routes/sync.js + routes/jobs/shared/bookstack.js auftauchen.
//
