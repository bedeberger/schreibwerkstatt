'use strict';
// Generischer "latest"-GitHub-Release-Leser fuer die nativen Clients dieses
// Projekts (macOS-Focus-Writer, Android-App). Die Web-App zeigt damit in /me
// Version + Download-Link an. Die Binaries (.dmg/.apk) liegen NICHT im Repo,
// sondern als Release-Assets auf dem GitHub-CDN — die UI verlinkt direkt darauf
// (kein Download-Proxy).
//
...
// Das Token ist account-weit gueltig und deckt beide Client-Repos ab.
//
...
//   repo:     'owner/name'
//   assetExt: '.dmg' | '.apk' (case-insensitive gematcht)
//   assetKey: Feldname des Asset-Objekts im Resultat ('dmg' | 'apk')
