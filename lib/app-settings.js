...
const DEFAULTS = {
  ...
  // Wert). Erlauben z.B. Opus 4.8 mit 128K Output und vollem Kontext für die gründlichere
  // Extraktion, während global Sonnet 4.6 / 64K fürs Lektorat läuft. WICHTIG: max_tokens_out
  // muss zum komplett-Modell passen (Sonnet 4.6 ≤ 64000, Opus 4.8 ≤ 128000) – ein zu hoher
  // Wert für das gewählte Modell führt zu HTTP 400.
  ...
  // der Erst-Extraktion zusätzlich gezielt nach FEHLENDEN Figuren/Schauplätzen gesucht
  // wird (Long-Tail-Recall). 0 = aus (Default; jeder Pass kostet Extra-Tokens/Dauer).
  // Loop-until-dry: stoppt früher, sobald eine Runde nichts Neues liefert.
  'ai.komplett.completeness_passes': 0,
