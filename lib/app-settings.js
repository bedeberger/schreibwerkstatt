...
const DEFAULTS = {
  ...
  // Claude-Split (Objektiv-Pass + Stil-Pass): Anzahl paralleler Objektiv-Läufe,
  // deren übereinstimmende Funde (Konsens) behalten werden. 1 = Split AUS (alter
  // kombinierter Single-Call). Nur Cloud/Claude – lokale Provider fahren immer 1.
  'ai.lektorat_objective_runs': 3,
