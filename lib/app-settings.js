...
const DEFAULTS = {
  ...
  // Phase 4a2: hCaptcha-Schutz fuer /register. Leer = Captcha aus; harter
  // Rate-Limit (3/h/IP) bleibt unabhaengig davon aktiv.
  'auth.captcha.site_key':     '',
  'auth.captcha.secret_key':   '',
  // Phase 4a2: Maximalalter pending-Anfragen; Cron setzt sie danach auf
  ...
  // Phase 8: Source-Read-Only-Marker fuer Backend-Migration. Wert = Name des
  ...
  // Phase 2: Pro-Seite-Max fuer page_revisions. Cleanup-Hook in
  // lib/cache-cleanup.js purged Ueberschuss via ROW_NUMBER pro page_id.
  // Range 10..500; Default 50 (BookStack-Default-Parity).
