...
const DEFAULTS = {
  ...
  // Per-Job-Override nur für die Komplettanalyse-Familie (leer = folgt ai.claude.model).
  // Erlaubt z.B. Opus für die gründlichere Extraktion, während global Sonnet läuft.
