...
/** Wie tServer, aber ersetzt `{name}`-Platzhalter aus `params`. Unbekannte
 *  Platzhalter bleiben stehen — gibt einen Hinweis, dass Param fehlte. */
function tServerParams(key, params, locale) {
  const str = tServer(key, locale);
...
module.exports = { tServer, tServerParams, resolveI18n, resolveI18nTree };
