...
const _FAMILY_PREFIXES = [
  'claude-opus-4-8', 'claude-opus-4-7', 'claude-opus-4-5', 'claude-opus-4-1', 'claude-opus-4-0',
...
//
// LIMITATION 1M-Kontext: Wird das Komplett-Profil mit context_window.komplett > 200000
// (1M-Beta, lib/ai.js#_claudeBetaHeader) gefahren, berechnet Anthropic fuer Input > 200K
// Tokens einen Long-Context-Aufschlag. Dieser Tarif ist hier NICHT abgebildet — der
// 1M-Single-Pass wird zum Standard-Opus-Tarif verbucht (leichte Unterverrechnung). Fuer
// die exakte Abrechnung: PRICING pro Modell um ein optionales long_context-Subobjekt
// erweitern und hier bei provider==='claude' && tokensIn > 200000 die erhoehten Saetze
// anwenden (Anthropic-Preisseite vor Implementierung gegenpruefen).
