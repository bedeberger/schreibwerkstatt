...
async function _callClaude(messages, systemPrompt, onProgress, maxTokensOverride, signal, cacheLastMessage, modelOverride, jsonSchema) {
  ...
  while (true) {
    try {
      return await _callClaudeAttempt(messages, systemPrompt, onProgress, maxTokensOverride, signal, cacheLastMessage, modelOverride, schema);
    } catch (e) {
...
async function _callClaudeAttempt(messages, systemPrompt, onProgress, maxTokensOverride, signal, cacheLastMessage, modelOverride, jsonSchema) {
    ...
    const outputConfig = { ...(_claudeOutputConfigParams(model).output_config || {}) };
