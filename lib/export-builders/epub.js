...
function _buildContentOPF(meta, provenance = {}) {
  ...
  if (extra) opf = opf.replace('</metadata>', `        ${extra}\n    </metadata>`);
  return opf;
}
...
${tocBody}
  ...
  const contentOPF = _buildContentOPF(meta, { instanceUrl: opts.instanceUrl, exportedBy: opts.exportedBy });
