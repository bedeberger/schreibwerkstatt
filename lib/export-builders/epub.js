...
${tocBody}
  ...
  const css = meta && meta.epub_justify === false ? EPUB_CSS : EPUB_CSS + EPUB_CSS_JUSTIFY;
...
module.exports = { buildEpub, _resolveEpubMeta, _countUnfetchableImages, _buildFrontmatter, _buildBackmatter, _proseToXhtml };
