...
function runDevSeedIfNeeded() {
  ...
  logger.info(`LOCAL_DEV_SEED: Buch "Devmode-Testbuch" (id=${bookId}) mit ${_PROSE.length} Kapiteln + ${pageCount} Pages, ${seeded.links} Share-Links + ${seeded.comments} Kommentaren angelegt.`);
  return { bookId, chapters: _PROSE.length, pages: pageCount, ...seeded };
}
