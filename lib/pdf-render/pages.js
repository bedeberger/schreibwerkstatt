...
function _renderToc(doc, toc, entries, lang, font, baseMargins) {
  ...
  for (let ci = 0; ci < entries.length; ci++) {
    ...
    // Passt die Zeile nicht mehr auf die aktuelle TOC-Seite → neue Seite. VOR
    // dem Write prüfen, damit Titel + Nummer + Leader garantiert zusammen auf
    // der finalen Seite landen.
