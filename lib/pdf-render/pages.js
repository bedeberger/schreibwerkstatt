...
// extras.imprintPosition. Gibt true zurück, wenn eine Seite gerendert wurde.
...
function _renderToc(doc, toc, entries, lang, font) {
  ...
  for (const c of entries) {
    ...
    const x = doc.page.margins.left + c.level * indentPt;
    const usableW = doc.page.width - x - doc.page.margins.right - reservePt;
    ...
    if (leader !== 'none' && toc.showPageNumbers && reservePt > 0) {
      ...
      const leaderStartX = x + titleWidth + 4;
