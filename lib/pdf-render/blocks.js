...
function _enforceWidowOrphan(doc, runs, opts) {
  ...
  doc.font('body').fontSize(opts.sizePt);
  const measureOpts = {
    align: opts.align,
...
async function _renderBlock(doc, block, ctx) {
  const { font, indent = 0, token, imageCache, dropCapHint, firstParaHint, bodyFirstLineIndentPt = 0, columns = 1, columnGap = 0, hyphenate = null, widowOrphanControl = true, skipWidowOrphan = false, dpiWarnThreshold = 0, dpiWarnings = null } = ctx;
