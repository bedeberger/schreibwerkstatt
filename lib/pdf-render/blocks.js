...
async function _renderBlock(doc, block, ctx) {
  const { font, indent = 0, token, imageCache, dropCapHint, firstParaHint, bodyFirstLineIndentPt = 0, columns = 1, columnGap = 0, hyphenate = null, widowOrphanControl = true, skipWidowOrphan = false } = ctx;
