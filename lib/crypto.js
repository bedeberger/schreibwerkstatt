...
function getKey() {
  ...
  // Salt-Wert ist Pflicht-konstant: Aenderung macht alle bestehenden
  // `enc:v1:`-Werte in app_settings (Google-OAuth-Secret, Claude-API-Key,
  // SMTP-App-Password, Captcha-Secret) unentschluesselbar.
